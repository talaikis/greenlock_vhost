...
const approveDomains = (opts, certs, cb) => {
  ...
  if (certs) {
    ...
    opts.domains = [
      ...
      'www.identiform.com',
      'www.blueblood.ltd',
      'sales.identiform.com',
      'act.identiform.com',
      'ipfs.identiform.com',
      'nakamotowallet.org',
      'www.nakamotowallet.org',
      'talaikis.com',
      'www.talaikis.com',
      'ufunc.com',
      'www.ufunc.com'
...
const router = {
  ...
  'sales.identiform.com': 'sales',
  'act.identiform.com': 'act',
  'ipfs.identiform.com': 'ipfs',
  'nakamotowallet.org': 'nakamoto',
  'www.nakamotowallet.org': 'nakamoto',
  'talaikis.com': 'talaikis',
  'www.talaikis.com': 'talaikis',
  'ufunc.com': 'ufunc',
  'www.ufunc.com': 'ufunc'
}
